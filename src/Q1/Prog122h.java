...
public class Prog122h {
    public static void main(String[] args) {
        System.out.println("Num     Square     SQR     Cube     4th Root");
        for (int lcv = 1; lcv < 21; lcv++){
            int sqr = (int)Math.pow(lcv,2);
            double sqrt = Math.pow(lcv,0.5);
            int cube = (int)Math.pow(lcv,3);
            double forth = Math.pow(lcv,0.25);
            System.out.println(lcv + "       " + sqr + "       " + sqrt + "       " + cube + "       " + forth);
        }
    }
}
/*
Num     Square     SQR     Cube     4th Root
1       1       1.0       1       1.0
